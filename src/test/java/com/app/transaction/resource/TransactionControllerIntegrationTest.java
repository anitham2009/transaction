...
public class TransactionControllerIntegrationTest {
	...
	public void testCreateTransaction() throws Exception {
		...
		TransactionResponse postResponse = restTemplate.postForObject(getRootURL(), transactionRequest,
	...
	public void testCreateTransactionException() throws Exception {
		TransactionRequest transactionRequest = (TransactionRequest) CommonUtil
				.retrieveObject(CommonConstants.TRANSACTION_INVALID_REQ_FILE, TransactionRequest.class);
		TransactionResponse postResponse = restTemplate.postForObject(getRootURL(), transactionRequest,
				TransactionResponse.class);
		assertNotNull(postResponse);
